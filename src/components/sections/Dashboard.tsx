  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <StatCard title="Registrerade Elever" value="247" description="Totalt antal elever" icon={<Users className="h-6 w-6 text-primary-foreground/80" />} />
        <StatCard title="Bokningar Idag" value="8" description="Planerade och genomförda" icon={<CalendarClock className="h-6 w-6 text-primary-foreground/80" />} />
        <StatCard title="Väntande Vaccinationer" value="3" description="Kommande denna vecka" icon={<ShieldAlert className="h-6 w-6 text-primary-foreground/80" />} />
        <StatCard title="Aktiva Medicinska Ärenden" value="12" description="Pågående uppföljningar" icon={<Activity className="h-6 w-6 text-primary-foreground/80" />} />
      </div>
